...
Section Uninstall
	...
	Delete /RebootOk "$InstDir\images\cannon.bmp"
	Delete /RebootOk "$InstDir\images\font.bmp"
	Delete /RebootOk "$InstDir\images\flail.bmp"
	Delete /RebootOk "$InstDir\images\health.bmp"
	Delete /RebootOk "$InstDir\images\monHealth.bmp"
	
	Delete /RebootOk "$InstDir\images\greenMonster.bmp"
	Delete /RebootOk "$InstDir\images\blackMonster.bmp"
	Delete /RebootOk "$InstDir\images\bat.bmp"
	Delete /RebootOk "$InstDir\images\tree.bmp"
	Delete /RebootOk "$InstDir\images\cloud.bmp"
	Delete /RebootOk "$InstDir\images\goo.bmp"
	Delete /RebootOk "$InstDir\images\ladyBug.bmp"
	...
	Delete /RebootOk "$InstDir\images\motherBat.bmp"
